  ...
  return (
    <>
      ...
      <div
        ...
        className="w-96 h-36 bg-cyan-500 flex items-center justify-center cursor-pointer rounded-lg p-6"
      >
        <h5 className="text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50">
          Detail Card
        </h5>
      ...
      <div
        ...
        className="w-96 h-36 bg-purple-400 flex items-center justify-center cursor-pointer rounded-lg p-6"
      >
        <h5 className="text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50">
          Split Card
        </h5>
